...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		...
		desktop: [
			"assets/images/DesktopWallpaper/c1.png",
			"assets/images/DesktopWallpaper/c2.png",
			"assets/images/DesktopWallpaper/c3.png",
			"assets/images/DesktopWallpaper/c4.png",
			"assets/images/DesktopWallpaper/c5.png",
			"assets/images/DesktopWallpaper/c6.png",
		],
		// 移动背景图片（支持单张或多张随机）
		// mobile: "assets/images/MobileWallpaper/m1.avif",
		mobile: [
			"assets/images/MobileWallpaper/c1.png",
			"assets/images/MobileWallpaper/c2.png",
			"assets/images/MobileWallpaper/c3.png",
			"assets/images/MobileWallpaper/c4.png",
			"assets/images/MobileWallpaper/c5.png",
			"assets/images/MobileWallpaper/c6.png",
		],
		// 背景视频播放地址
